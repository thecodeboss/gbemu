...
- The in-run display card “Menu” button now asks for confirmation (progress will be lost) and then returns to the main menu instead of opening the file picker directly.
