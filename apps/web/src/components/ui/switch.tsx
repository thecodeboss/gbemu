  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block size-[1.75rem] bg-background shadow-[3px_3px_0_var(--color-border)] transition-transform data-[state=checked]:translate-x-[1.75rem] data-[state=unchecked]:translate-x-0",
        )}
      />
    </SwitchPrimitive.Root>
  );
